package com.example.xyzreader.adpters;
...
public class Adapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public Adapter(Cursor mCursor, Context context) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        // In CLick In List   ToDo Design List XMl
        view.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(Intent.ACTION_VIEW);
                context.startActivity(new Intent(Intent.ACTION_VIEW,
                        ItemsContract.Items.buildItemUri(getItemId(vh.getAdapterPosition()))).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
            }
        });
        return vh;
    }
